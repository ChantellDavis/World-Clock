...
losAngelesTimeDataElement.innerHTML = (losAngelesTimeElement.tz(`America_Los_Angeles`).format(`h:mm:ss [<small>]A[</small>]`));
...
SydneyTimeDataElement.innerHTML = (sydneyTimeElement.tz(`Australia/Sydney`).format('h:mm:ss [<small>]A[</small>]'))
...
let tokyoTimeElement = moment();
 ...
 tokyoTimeDataElement.innerHTML = (tokyoTimeElement.tz(`Asia/Tokyo`).format('h:mm:ss [<small>]A[</small>]'));
